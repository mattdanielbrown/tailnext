...
import { AnnouncementProps, FooterProps, HeaderProps } from '~/shared/types';

// Announcement data
export const announcementData: AnnouncementProps = {
  title: 'NEW',
  callToAction: {
    text: 'This template is made with Next.js 16 using the App Router »',
...
export const footerData: FooterProps = {
  ...
  footNote: (
    <div className="mr-4 text-sm rtl:mr-0 rtl:ml-4">
      <span className="float-left mr-1.5 h-5 w-5 rounded-xs bg-[url(https://arthelokyo.com/favicon.svg)] bg-cover md:-mt-0.5 md:h-6 md:w-6 rtl:float-right rtl:mr-0 rtl:ml-1.5"></span>
      <span>
        Made by{' '}
        <a
