        ...
        {prices &&
          prices.map(
            ({ title, subtitle, price, period, items, callToAction, hasRibbon = false, ribbonTitle }, index) => (
              ...
              >
                {price && period && (
                  <div className="card flex max-w-sm flex-col justify-between text-center">
                    {hasRibbon && ribbonTitle && (
                      <div className="absolute right-[-5px] top-[-5px] z-[1] h-[100px] w-[100px] overflow-hidden text-right rtl:left-[-5px] rtl:right-auto">
                    ...
                    <div className="px-2 py-0">
                      {title && (
                        <h3 className="mb-2 text-center text-xl font-semibold uppercase leading-6 tracking-wider">
                          {title}
                        </h3>
                      )}
                      {subtitle && (
                        <p className="font-light text-gray-600 dark:text-slate-400 sm:text-lg">{subtitle}</p>
                      )}
                      <div className="my-8">
                        ...
                        <span className="text-base lowercase leading-6 text-gray-600 dark:text-slate-400">
                          {period}
                        </span>
                      </div>
                      {items && (
